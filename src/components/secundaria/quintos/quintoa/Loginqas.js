...
const Loginqas =(props)=>{
  ...
  const usuario={correomovil,contrasena}
   const respuesta = await Axios.post('/quintoasec/login',usuario); 
  ...
  if(mensaje!=='Bienvenido') {
   ...
   window.location.href='/contenedorqas'
    }
    }
    const salir= () =>{
    ...
    const reg= () =>{
        ...
        sessionStorage.clear()
        window.location.href="/registerqas"
      }
