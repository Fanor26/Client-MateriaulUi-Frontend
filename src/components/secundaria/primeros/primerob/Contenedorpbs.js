...
const Contenedorpbs = () => {
  ...
  return (
    <>   
      ...
      <Hidden xlDown>
        <Cajonpbs variant="permanent" open={true} />
      </Hidden>

      <Hidden xlUp>
        <Cajonpbs variant="temporary" open={abrir} onClose={accionAbrir} />
      </Hidden>
