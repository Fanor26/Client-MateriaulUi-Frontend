...
const Logintas =(props)=>{
  ...
  const usuario={correomovil,contrasena}
   const respuesta = await Axios.post('/terceroasec/login',usuario); 
  ...
  if(mensaje!=='Bienvenido') {
   ...
   window.location.href='/contenedortas'
    }
    }
    const salir= () =>{
    ...
    const reg= () =>{
        ...
        sessionStorage.clear()
        window.location.href="/registertas"
      }
